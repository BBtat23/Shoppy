...
class ShoppyDbHelper extends SQLiteOpenHelper {
    ...
    /**
     * Constructs a new instance of {@link ShoppyDbHelper}.
     *
     * @param context of the app
     */
    public ShoppyDbHelper(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String SQL_CREATE_FOOD_TABLE =  "CREATE TABLE " + ShoppyContract.ShoppyEntry.TABLE_NAME + " ("
                + ShoppyContract.ShoppyEntry._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + ShoppyContract.ShoppyEntry.COLUMN_FOOD_NAME + " TEXT NOT NULL );";
